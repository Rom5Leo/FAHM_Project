...
def plot_label_distributions(df, labels, features, groups=None):
    """Distribution of each feature per label group (overlaid). Returns fig.
    groups: which labels to show (default: healthy, prefail, infail, degraded)."""
    groups = groups or ["healthy", "prefail", "infail", "degraded"]
